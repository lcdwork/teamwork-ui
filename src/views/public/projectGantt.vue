  ...
  >
    ...
    <template v-if="self_date_type === 'yearAndMonth'">
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <div :style="{'background': scope.row.background}" :class="dayGanttType(scope.row, month.full_date, 'months')"></div>
    ...
    <template v-else-if="self_date_type === 'yearAndWeek'">
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <div :style="{'background': scope.row.background}" :class="dayGanttType(scope.row, t.full_date, 'week')"></div>
    ...
    <template v-else>
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <div :style="{'background': scope.row.background}" :class="dayGanttType(scope.row, t.full_date)"></div>
...
export default {
  ...
  created() {
    ...
    this.getDicts("gantt_random_color").then(response => {
      this.randomColorList = response.data;
    })
  }
};
</script>
